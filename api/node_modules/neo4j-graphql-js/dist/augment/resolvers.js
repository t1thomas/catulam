...
var augmentResolvers = function augmentResolvers(augmentedTypeMap, operationTypeMap, resolvers, config) {
  ...
  var derivedTypes = (0, _keys["default"])(augmentedTypeMap).filter(function (e) {
    return augmentedTypeMap[e].kind === 'InterfaceTypeDefinition' || augmentedTypeMap[e].kind === 'UnionTypeDefinition';
  });
