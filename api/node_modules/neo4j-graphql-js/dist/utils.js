...
var getInterfaceDerivedTypeNames = function getInterfaceDerivedTypeNames(schema, interfaceName) {
  var implementingTypeMap = schema._implementations ? schema._implementations[interfaceName] : {};
  var implementingTypes = (0, _values["default"])(implementingTypeMap).map(function (type) {
    return type.name;
  });
