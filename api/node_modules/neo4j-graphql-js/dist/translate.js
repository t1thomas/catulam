...
var relationFieldOnNodeType = function relationFieldOnNodeType(_ref3) {
  ...
  tailParams.initial = "".concat(initial).concat(fieldName, ": ").concat(!(0, _utils.isArrayType)(fieldType) ? 'head(' : '').concat(orderByParam ? temporalOrdering ? "[sortedElement IN apoc.coll.sortMulti(" : "apoc.coll.sortMulti(" : '', "[(").concat((0, _utils.safeVar)(variableName), ")").concat(isUnionTypeField ? "--" : "".concat(relDirection === 'in' || relDirection === 'IN' ? '<' : '', "-[:").concat((0, _utils.safeLabel)([relType]), "]-").concat(relDirection === 'out' || relDirection === 'OUT' ? '>' : ''), "(").concat(safeVariableName, ":".concat((0, _utils.safeLabel)([innerSchemaType.name].concat((0, _toConsumableArray2["default"])((0, _utils.getAdditionalLabels)(resolveInfo.schema.getType(innerSchemaType.name), cypherParams)))))).concat(queryParams, ")").concat(whereClauses.length > 0 ? " WHERE ".concat(whereClauses.join(' AND ')) : '', " | ").concat(mapProjection, "]").concat(orderByParam ? ", [".concat(buildSortMultiArgs(orderByParam), "])").concat(temporalOrdering ? " | sortedElement { .*,  ".concat(neo4jTypeOrderingClauses(selections, innerSchemaType), "}]") : "") : '').concat(!(0, _utils.isArrayType)(fieldType) ? ')' : '').concat(skipLimit, " ").concat(commaIfTail);
...
var relationTypeFieldOnNodeType = function relationTypeFieldOnNodeType(_ref4) {
  ...
  if (innerSchemaTypeRelation.from === innerSchemaTypeRelation.to) {
    tailParams.initial = "".concat(initial).concat(fieldName, ": {").concat(subSelection[0], "}").concat(skipLimit, " ").concat(commaIfTail);
    return [tailParams, subSelection];
  }
...
var relationTypeMutationPayloadField = function relationTypeMutationPayloadField(_ref6) {
  ...
  return _objectSpread({
    initial: "".concat(initial).concat(fieldName, ": ").concat(mapProjection).concat(skipLimit, " ").concat(commaIfTail)
  }, tailParams, {
...
var directedNodeTypeFieldOnRelationType = function directedNodeTypeFieldOnRelationType(_ref7) {
  ...
  if (fromTypeName === toTypeName) {
    ...
    if ((0, _utils.isRelationTypeDirectedField)(fieldName)) {
      ...
      var whereClauses = [].concat((0, _toConsumableArray2["default"])(neo4jTypeClauses), (0, _toConsumableArray2["default"])(filterPredicates));
      tailParams.initial = "".concat(initial).concat(fieldName, ": ").concat(!(0, _utils.isArrayType)(fieldType) ? 'head(' : '', "[(").concat((0, _utils.safeVar)(variableName), ")").concat(isFromField ? '<' : '', "-[").concat((0, _utils.safeVar)(relationshipVariableName), ":").concat((0, _utils.safeLabel)(relType)).concat(queryParams, "]-").concat(isToField ? '>' : '', "(").concat((0, _utils.safeVar)(nestedVariable)).concat(!isInterfaceTypeField ? ":".concat((0, _utils.safeLabel)([fromTypeName].concat((0, _toConsumableArray2["default"])((0, _utils.getAdditionalLabels)(resolveInfo.schema.getType(fromTypeName), cypherParams))))) : '', ") ").concat(whereClauses.length > 0 ? "WHERE ".concat(whereClauses.join(' AND '), " ") : '', "| ").concat(relationshipVariableName, " {").concat( // TODO switch to using buildMapProjection to support fragments
      isInterfaceTypeField ? "".concat(fragmentType(nestedVariable, innerSchemaType.name)).concat(subSelection[0] ? ", ".concat(subSelection[0]) : '') : subSelection[0], "}]").concat(!(0, _utils.isArrayType)(fieldType) ? ')' : '').concat(skipLimit, " ").concat(commaIfTail);
      return [tailParams, subSelection];
    } else {
      tailParams.initial = "".concat(initial).concat(fieldName, ": ").concat(variableName, " {").concat(subSelection[0], "}").concat(skipLimit, " ").concat(commaIfTail); // Case of a renamed directed field
...
var translateQuery = function translateQuery(_ref10) {
  ...
  var hasOnlySchemaTypeFragments = schemaTypeFields.length > 0 && (0, _keys["default"])(derivedTypeMap).length === 0; // TODO refactor
...
var buildTypeCompositionPredicate = function buildTypeCompositionPredicate(_ref11) {
...
var nodeQuery = function nodeQuery(_ref13) {
  var resolveInfo = _ref13.resolveInfo,
      ...
      additionalLabels = _ref13$additionalLabe === void 0 ? [] : _ref13$additionalLabe,
...
var getUnionLabels = function getUnionLabels(_ref15) {
  ...
  (0, _keys["default"])(typeMap).map(function (key) {
    ...
    if ((0, _types.isUnionTypeDefinition)({
      ...
      var unionTypeName = astNode.name.value;

      if (astNode.types.find(function (type) {
...
var processFilterArgument = function processFilterArgument(_ref24) {
  var fieldArgs = _ref24.fieldArgs,
      ...
      rootIsRelationType = _ref24$rootIsRelation === void 0 ? false : _ref24$rootIsRelation;
...
var analyzeFilterArguments = function analyzeFilterArguments(_ref25) {
  ...
  return (0, _entries["default"])(filterValue).reduce(function (_ref26, _ref27) {
...
var serializeNeo4jTypeParam = function serializeNeo4jTypeParam(filterValue) {
  ...
  var serializedValues = filterValue.reduce(function (serializedValues, filter) {
    ...
    if (filter['formatted']) serializedValue = filter['formatted'];else {
      serializedValue = (0, _entries["default"])(filter).reduce(function (serialized, _ref34) {
...
var translateFilterArguments = function translateFilterArguments(_ref36) {
  ...
  return (0, _entries["default"])(filterFieldMap).reduce(function (translations, _ref37) {
...
var translateScalarFilter = function translateScalarFilter(_ref40) {
  var isListFilterArgument = _ref40.isListFilterArgument,
...
var decideNullSkippingPredicate = function decideNullSkippingPredicate(_ref41) {
  var parameterPath = _ref41.parameterPath,
...
var translateNullFilter = function translateNullFilter(_ref42) {
  var filterOperationField = _ref42.filterOperationField,
      filterOperationType = _ref42.filterOperationType,
      filterParam = _ref42.filterParam,
      propertyPath = _ref42.propertyPath,
...
var buildOperatorExpression = function buildOperatorExpression(_ref43) {
  var filterOperationType = _ref43.filterOperationType,
...
var translateLogicalFilter = function translateLogicalFilter(_ref45) {
  var filterValue = _ref45.filterValue,
...
var translateRelationFilter = function translateRelationFilter(_ref46) {
  var rootIsRelationType = _ref46.rootIsRelationType,
      ...
      isReflexiveRelationType = _ref46.isReflexiveRelationType,
      isReflexiveTypeDirectedField = _ref46.isReflexiveTypeDirectedField,
      ...
      fieldType = _ref46.fieldType,
      schema = _ref46.schema,
      schemaType = _ref46.schemaType,
      innerSchemaType = _ref46.innerSchemaType,
      ...
      parentSchemaType = _ref46.parentSchemaType,
...
var decideRelationFilterMetadata = function decideRelationFilterMetadata(_ref47) {
  var fieldName = _ref47.fieldName,
...
var buildRelationPredicate = function buildRelationPredicate(_ref48) {
  var rootIsRelationType = _ref48.rootIsRelationType,
      isRelationType = _ref48.isRelationType,
      isReflexiveRelationType = _ref48.isReflexiveRelationType,
      isReflexiveTypeDirectedField = _ref48.isReflexiveTypeDirectedField,
      thisType = _ref48.thisType,
      isListFilterArgument = _ref48.isListFilterArgument,
      relatedType = _ref48.relatedType,
      schemaType = _ref48.schemaType,
      innerSchemaType = _ref48.innerSchemaType,
      fieldName = _ref48.fieldName,
      fieldType = _ref48.fieldType,
      ...
      parameterPath = _ref48.parameterPath,
      nullFieldPredicate = _ref48.nullFieldPredicate,
      pathExistencePredicate = _ref48.pathExistencePredicate,
      predicateListVariable = _ref48.predicateListVariable,
      rootPredicateFunction = _ref48.rootPredicateFunction;
...
var buildPredicateFunction = function buildPredicateFunction(_ref49) {
  var nullFieldPredicate = _ref49.nullFieldPredicate,
      ...
      predicates = _ref49.predicates,
      listElementVariable = _ref49.listElementVariable;
...
var decidePredicateFunction = function decidePredicateFunction(_ref50) {
  var filterOperationField = _ref50.filterOperationField,
      filterOperationType = _ref50.filterOperationType,
      isRelationTypeNode = _ref50.isRelationTypeNode,
      isRelationList = _ref50.isRelationList;
...
var buildRelatedTypeListComprehension = function buildRelatedTypeListComprehension(_ref51) {
  var rootIsRelationType = _ref51.rootIsRelationType,
      variableName = _ref51.variableName,
      thisType = _ref51.thisType,
      relatedType = _ref51.relatedType,
      relationLabel = _ref51.relationLabel,
      relationDirection = _ref51.relationDirection,
      isRelationTypeNode = _ref51.isRelationTypeNode,
      isRelationType = _ref51.isRelationType;
  var relationVariable = buildRelationVariable(thisType, relatedType);
...
var buildFilterPredicates = function buildFilterPredicates(_ref52) {
  var parentSchemaType = _ref52.parentSchemaType,
      ...
      typeFields = _ref52.typeFields,
      schema = _ref52.schema,
      isListFilterArgument = _ref52.isListFilterArgument;
  return (0, _entries["default"])(filterValue).reduce(function (predicates, _ref53) {
...
var translateNeo4jTypeFilter = function translateNeo4jTypeFilter(_ref55) {
  var typeName = _ref55.typeName,
      isRelationTypeNode = _ref55.isRelationTypeNode,
      filterValue = _ref55.filterValue,
      variableName = _ref55.variableName,
      filterOperationField = _ref55.filterOperationField,
      filterOperationType = _ref55.filterOperationType,
      fieldName = _ref55.fieldName,
      filterParam = _ref55.filterParam,
      fieldType = _ref55.fieldType,
      parameterPath = _ref55.parameterPath,
      parentParamPath = _ref55.parentParamPath,
      isListFilterArgument = _ref55.isListFilterArgument,
      nullFieldPredicate = _ref55.nullFieldPredicate;
  var predicate = '';
...
var buildNeo4jTypePredicate = function buildNeo4jTypePredicate(_ref56) {
  var typeName = _ref56.typeName,
      fieldName = _ref56.fieldName,
      fieldType = _ref56.fieldType,
      ...
      rootPredicateFunction = _ref56.rootPredicateFunction,
      cypherTypeConstructor = _ref56.cypherTypeConstructor;
  // ex: project -> person_filter_project
