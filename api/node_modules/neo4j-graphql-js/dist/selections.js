...
function buildCypherSelection(_ref) {
  ...
  if (isFragmentedInterfaceType || isUnionType || isFragmentedObjectType) {
    ...
    if (hasOnlySchemaTypeFragments || isFragmentedObjectType) {
      ...
      var _derivedTypes$reduce = derivedTypes.reduce(function (_ref8, derivedType) {
        ...
        if (mergedTypeSelections.length) {
          ...
          var _recurse = recurse(_objectSpread({}, tailParams, {
            schemaType: schemaType,
    ...
    if (isIntrospectionField) {
      ...
      var _queryParams2 = (0, _utils.paramsToString)((0, _utils.innerFilterParams)(filterParams, neo4jTypeArgs));
...
var translateScalarTypeField = function translateScalarTypeField(_ref10) {
  ...
  if (fieldName === _fields.Neo4jSystemIDField) {
    ...
    if (customCypherStatement) {
      ...
      return _objectSpread({
        initial: "".concat(initial).concat(fieldName, ": apoc.cypher.runFirstColumn(\"").concat(customCypherStatement, "\", {").concat((0, _utils.cypherDirectiveArgs)(variableName, headSelection, cypherParams, schemaType, resolveInfo, paramIndex), "}, false)").concat(commaIfTail)
      }, tailParams);
...
var aggregateFragmentedSelections = function aggregateFragmentedSelections(_ref13) {
...
var mergeInterfacedObjectFragments = function mergeInterfacedObjectFragments(_ref14) {
  ...
  var derivedTypeMap = _objectSpread({}, objectFragmentMap, {}, interfaceFragmentMap);
...
var mergeFragmentedSelections = function mergeFragmentedSelections(_ref15) {
  ...
  selections.forEach(function (selection) {
    ...
    if (fieldKind === _graphql.Kind.FIELD) {
      ...
      if (!subSelecionFieldMap[fieldName]) {
        ...
        var alreadySelected = subSelecionFieldMap[fieldName].selectionSet ? subSelecionFieldMap[fieldName].selectionSet.selections : [];
        ...
        if (alreadySelected.length && selected.length) {
          ...
          subSelecionFieldMap[fieldName].selectionSet.selections = mergeFragmentedSelections({
  ...
  return [].concat((0, _toConsumableArray2["default"])((0, _values["default"])(subSelecionFieldMap)), fragments);
};
...
var getUnionDerivedTypes = function getUnionDerivedTypes(_ref17) {
  var _ref17$derivedTypeMap = _ref17.derivedTypeMap,
      derivedTypeMap = _ref17$derivedTypeMap === void 0 ? {} : _ref17$derivedTypeMap,
      resolveInfo = _ref17.resolveInfo;
  var typeMap = resolveInfo.schema.getTypeMap();
  var fragmentDefinitions = resolveInfo.fragments;
  var uniqueFragmentTypeMap = (0, _entries["default"])(derivedTypeMap).reduce(function (uniqueFragmentTypeMap, _ref18) {
...
var buildComposedTypeListComprehension = function buildComposedTypeListComprehension(_ref25) {
  var derivedType = _ref25.derivedType,
      ...
      fragmentedQuery = _ref25$fragmentedQuer === void 0 ? '' : _ref25$fragmentedQuer,
...
var concatenateComposedTypeLists = function concatenateComposedTypeLists(_ref26) {
